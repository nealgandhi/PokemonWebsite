...
function Body() {
  ...
  if (!loading) {
    return (
      <div className="bg-black">
        <div
          ...
          className="place-content-center align-center py-8"
        >
          <input
            className="body-input justify-self-center"
            type="text"
    ...
    return (
      <div className="text-center text-xl text-gray-100 bg-black h-screen">
